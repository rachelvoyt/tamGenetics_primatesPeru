...
sum(duplicated(ppReads_outliers_summary$locus))
...
Below are boxplots showing primer-probe reads per locus within LWED and SIMP sample subsets, with overamplifiers highlighted when present in both species. Primer-probe reads counts are based on GTscore values.
