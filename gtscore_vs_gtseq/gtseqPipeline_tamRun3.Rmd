...
This document outlines data analysis for tamGenetics_run3 using the "GTseq pipeline" ([GitHub link](https://github.com/GTseq/GTseq-Pipeline)) created by Nate Campbell.
...
Below I'm taking the primer-probe file that I used for the GTscore pipeline and reformatting it for the GTseq_SeqTest.pl script.
