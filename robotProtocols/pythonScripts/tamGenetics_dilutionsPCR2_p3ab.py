...
def run(protocol):
    ...
    # transfers for SET 1: pcr1a to dilution plate
    for line in transfer_info:
    ...
    # PAUSE 1: check pcr1a transfers
    protocol.pause("PAUSE 1: Check the dilution plate to ensure that all PCR1a products were transferred. Manually transfer any that are missing or low. Resume run.")

    # transfers for SET 2: pcr1b to dilution plate
    for line in transfer_info:
    ...
    # PAUSE 2: check pcr1b transfers
    protocol.pause("PAUSE 2: Check the dilution plate to ensure that all PCR1b products were transferred. Manually transfer any that are missing or low. Resume run.")
