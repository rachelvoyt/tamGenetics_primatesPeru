...
This pipeline is to analyze the Nanopore (ONT) results for tamRun4 (the 30x3 sample type comparison project)
...
**NOTE** that of these samples, hair_tx105A_e1 was not added to PCR1; found the second elution too late to be included in the run. Treat as a negative when analyzing the data.
...
```{r}
sf_fullSet <- read.table("./04_tamRun4/01_nanopore/03_run4GTscore/ont_fullSet_sampleFiles.txt")

sf_pos <- read.table("./04_tamRun4/01_nanopore/03_run4GTscore/ont_pos_sampleFiles.txt")

sf_lwed <- read.table("./04_tamRun4/01_nanopore/03_run4GTscore/ont_lwed_sampleFiles.txt")

sf_simp <- read.table("./04_tamRun4/01_nanopore/03_run4GTscore/ont_simp_sampleFiles.txt")
```
...
sf_lwed <- sf_fullSet %>%
  filter(V1 %in% lwed$sampleFile_ont)

sf_simp <- sf_fullSet %>%
  filter(V1 %in% simp$sampleFile_ont)

sf_pos <- rbind(sf_lwed, sf_simp) %>%
  arrange(V1)

# Export sample files
write.table(sf_lwed, file = "./04_tamRun4/01_nanopore/03_run4GTscore/ont_lwed_sampleFiles.txt", sep = "\t", row.names = F, col.names = F, quote = F)

write.table(sf_simp, file = "./04_tamRun4/01_nanopore/03_run4GTscore/ont_simp_sampleFiles.txt", sep = "\t", row.names = F, col.names = F, quote = F)

write.table(sf_pos, file = "./04_tamRun4/01_nanopore/03_run4GTscore/ont_pos_sampleFiles.txt", sep = "\t", row.names = F, col.names = F, quote = F)
```
...
system2("perl",
        args = "./project_scripts/GTscore_AmpliconReadCounter_modified.pl -p ./05_tamRun5/03_run5GTscore/primerProbeFileV3_fullSet.txt --files ./04_tamRun4/01_nanopore/03_run4GTscore/ont_fullSet_sampleFiles.txt --inDir ./04_tamRun4/01_nanopore/02_run4Interleaved/ --outDir ./04_tamRun4/01_nanopore/03_run4GTscore/ --prefix ont_fullSet_")

# pos samples (no negs), dual loci
system2("perl",
        args="./project_scripts/GTscore_AmpliconReadCounter_modified.pl -p ./05_tamRun5/03_run5GTscore/primerProbeFileV3_dual.txt --files ./04_tamRun4/01_nanopore/03_run4GTscore/ont_pos_sampleFiles.txt --inDir ./04_tamRun4/01_nanopore/02_run4Interleaved/ --outDir ./04_tamRun4/01_nanopore/03_run4GTscore/ --prefix ont_posDual_")

# lwed samples, lwed + dual loci
system2("perl",
        args="./project_scripts/GTscore_AmpliconReadCounter_modified.pl -p ./05_tamRun5/03_run5GTscore/primerProbeFileV3_LWED.txt --files ./04_tamRun4/01_nanopore/03_run4GTscore/ont_lwed_sampleFiles.txt --inDir ./04_tamRun4/01_nanopore/02_run4Interleaved/ --outDir ./04_tamRun4/01_nanopore/03_run4GTscore/ --prefix ont_lwed_")

# simp samples, simp + dual loci
system2("perl",
        args="./project_scripts/GTscore_AmpliconReadCounter_modified.pl -p ./05_tamRun5/03_run5GTscore/primerProbeFileV3_SIMP.txt --files ./04_tamRun4/01_nanopore/03_run4GTscore/ont_simp_sampleFiles.txt --inDir ./04_tamRun4/01_nanopore/02_run4Interleaved/ --outDir ./04_tamRun4/01_nanopore/03_run4GTscore/ --prefix ont_simp_")
```
...
posDual_singleSNP_locusTable <- read.delim("./04_tamRun4/01_nanopore/03_run4GTscore/ont_posDual_LocusTable_singleSNPs.txt", header = TRUE, stringsAsFactors = FALSE)

posDual_singleSNP_alleleReads_0x <- read.delim("./04_tamRun4/01_nanopore/03_run4GTscore/ont_posDual_AlleleReads_singleSNPs.txt", header = TRUE, row.names = 1, stringsAsFactors = FALSE)
...
#write results
write.table(posDual_polyGenResults_singleSNP_0x, "./04_tamRun4/01_nanopore/03_run4GTscore/ont_posDual_polyGenResults_singleSNP_0x.txt", quote = FALSE, sep = "\t")
```
...
```{r Genotyping}
#load locus table and 10x allele reads file
LWED_singleSNP_locusTable <- read.delim("./04_tamRun4/01_nanopore/03_run4GTscore/ont_lwed_LocusTable_singleSNPs.txt", header = TRUE, stringsAsFactors = FALSE)

LWED_singleSNP_alleleReads_0x <- read.delim("./04_tamRun4/01_nanopore/03_run4GTscore/ont_lwed_AlleleReads_singleSNPs.txt", header = TRUE, row.names = 1, stringsAsFactors = FALSE)

#generate singleSNP genotypes using the polyGen algorithm
LWED_polyGenResults_singleSNP_0x <- polyGen(LWED_singleSNP_locusTable, LWED_singleSNP_alleleReads_0x)

#write results
write.table(LWED_polyGenResults_singleSNP_0x, "./04_tamRun4/01_nanopore/03_run4GTscore/ont_lwed_polyGenResults_singleSNP_0x.txt", quote = FALSE, sep = "\t")
```
...
```{r}
#load locus table and 10x allele reads file
SIMP_singleSNP_locusTable <- read.delim("./04_tamRun4/01_nanopore/03_run4GTscore/ont_simp_LocusTable_singleSNPs.txt", header = TRUE, stringsAsFactors = FALSE)

SIMP_singleSNP_alleleReads_0x <- read.delim("./04_tamRun4/01_nanopore/03_run4GTscore/ont_simp_AlleleReads_singleSNPs.txt", header = TRUE, row.names = 1, stringsAsFactors = FALSE)

#generate singleSNP genotypes using the polyGen algorithm
SIMP_polyGenResults_singleSNP_0x <- polyGen(SIMP_singleSNP_locusTable, SIMP_singleSNP_alleleReads_0x)

#write results
write.table(SIMP_polyGenResults_singleSNP_0x, "./04_tamRun4/01_nanopore/03_run4GTscore/ont_simp_polyGenResults_singleSNP_0x.txt", quote = FALSE, sep = "\t")
```
...
readCounts_original <- read.table("./04_tamRun4/01_nanopore/03_run4GTscore/ont_fullSet_AlleleReads_singleSNPs.txt")
...
readCounts_sum <- replace(readCounts10x, TRUE, lapply(readCounts10x, repl)) %>%
  mutate(across(everything(),as.numeric))

# Recode <10x loci with "0"
readCounts10x[readCounts_sum < 10] <- "0,0"
```
...
lwed_loci <- read.delim("./04_tamRun4/01_nanopore/03_run4GTscore/ont_lwed_LocusTable_singleSNPs.txt", header = TRUE, stringsAsFactors = FALSE)

simp_loci <- read.delim("./04_tamRun4/01_nanopore/03_run4GTscore/ont_simp_LocusTable_singleSNPs.txt", header = TRUE, stringsAsFactors = FALSE)

readCounts10x_lwed <- readCounts10x %>%
  select(lwed$sampleID_ont) %>%
  filter(rownames(.) %in% lwed_loci$Locus_ID)

readCounts10x_simp <- readCounts10x %>%
  select(simp$sampleID_ont) %>%
...
write.table(readCounts10x, "./04_tamRun4/01_nanopore/03_run4GTscore/ont_fullSet_AlleleReads_singleSNPs_10x.txt", quote = FALSE, sep = "\t")

write.table(readCounts10x_posDual, "./04_tamRun4/01_nanopore/03_run4GTscore/ont_posDual_AlleleReads_singleSNPs_10x.txt", quote = FALSE, sep = "\t")

write.table(readCounts10x_lwed, "./04_tamRun4/01_nanopore/03_run4GTscore/ont_lwed_AlleleReads_singleSNPs_10x.txt", quote = FALSE, sep = "\t")

write.table(readCounts10x_simp, "./04_tamRun4/01_nanopore/03_run4GTscore/ont_simp_AlleleReads_singleSNPs_10x.txt", quote = FALSE, sep = "\t")
```
...
fullSet_singleSNP_alleleReads_10x <- read.delim("./04_tamRun4/01_nanopore/03_run4GTscore/ont_fullSet_AlleleReads_singleSNPs_10x.txt", header = TRUE, row.names = 1, stringsAsFactors = FALSE)

#generate singleSNP genotypes using the polyGen algorithm, adjust "0" formatting
fullSet_polyGenResults_singleSNP_10x <- polyGen(fullSet_singleSNP_locusTable, fullSet_singleSNP_alleleReads_10x)

# write results
write.table(fullSet_polyGenResults_singleSNP_10x, "./04_tamRun4/01_nanopore/03_run4GTscore/ont_fullSet_polyGenResults_singleSNP_10x.txt", quote = FALSE, sep = "\t")
```
...
posDual_singleSNP_alleleReads_10x <- read.delim("./04_tamRun4/01_nanopore/03_run4GTscore/ont_posDual_AlleleReads_singleSNPs_10x.txt", header = TRUE, row.names = 1, stringsAsFactors = FALSE)

#generate singleSNP genotypes using the polyGen algorithm
posDual_polyGenResults_singleSNP_10x <- polyGen(posDual_singleSNP_locusTable, posDual_singleSNP_alleleReads_10x)

#write results
write.table(posDual_polyGenResults_singleSNP_10x, "./04_tamRun4/01_nanopore/03_run4GTscore/ont_posDual_polyGenResults_singleSNP_10x.txt", quote = FALSE, sep = "\t")
```
...
LWED_singleSNP_alleleReads_10x <- read.delim("./04_tamRun4/01_nanopore/03_run4GTscore/ont_lwed_AlleleReads_singleSNPs_10x.txt", header = TRUE, row.names = 1, stringsAsFactors = FALSE)

#generate singleSNP genotypes using the polyGen algorithm
LWED_polyGenResults_singleSNP_10x <- polyGen(LWED_singleSNP_locusTable, LWED_singleSNP_alleleReads_10x)

#write results
write.table(LWED_polyGenResults_singleSNP_10x, "./04_tamRun4/01_nanopore/03_run4GTscore/ont_lwed_polyGenResults_singleSNP_10x.txt", quote = FALSE, sep = "\t")
```
...
SIMP_singleSNP_alleleReads_10x <- read.delim("./04_tamRun4/01_nanopore/03_run4GTscore/ont_simp_AlleleReads_singleSNPs_10x.txt", header = TRUE, row.names = 1, stringsAsFactors = FALSE)

#generate singleSNP genotypes using the polyGen algorithm
SIMP_polyGenResults_singleSNP_10x <- polyGen(SIMP_singleSNP_locusTable, SIMP_singleSNP_alleleReads_10x)

#write results
write.table(SIMP_polyGenResults_singleSNP_10x,"./04_tamRun4/01_nanopore/03_run4GTscore/ont_simp_polyGenResults_singleSNP_10x.txt", quote = FALSE, sep = "\t")
```
...
```{r}
fullSet_singleSNP_alleleReads <- read.delim("./04_tamRun4/01_nanopore/03_run4GTscore/ont_fullSet_AlleleReads_singleSNPs.txt", header = TRUE, row.names = 1, stringsAsFactors = FALSE)

posDual_singleSNP_alleleReads <- read.delim("./04_tamRun4/01_nanopore/03_run4GTscore/ont_posDual_AlleleReads_singleSNPs.txt", header = TRUE, row.names = 1, stringsAsFactors = FALSE)

LWED_singleSNP_alleleReads <- read.delim("./04_tamRun4/01_nanopore/03_run4GTscore/ont_lwed_AlleleReads_singleSNPs.txt", header = TRUE, row.names = 1, stringsAsFactors = FALSE)

SIMP_singleSNP_alleleReads <- read.delim("./04_tamRun4/01_nanopore/03_run4GTscore/ont_simp_AlleleReads_singleSNPs.txt", header = TRUE, row.names = 1, stringsAsFactors = FALSE)
...
#write results
write.table(fullSet_singleSNP_summary_0x, "./04_tamRun4/01_nanopore/03_run4GTscore/ont_fullSet_singleSNP_summary_0x.txt", quote = FALSE, sep = "\t", row.names = FALSE)

write.table(posDual_singleSNP_summary_0x, "./04_tamRun4/01_nanopore/03_run4GTscore/ont_posDual_singleSNP_summary_0x.txt", quote = FALSE, sep = "\t", row.names = FALSE)

write.table(LWED_singleSNP_summary_0x, "./04_tamRun4/01_nanopore/03_run4GTscore/ont_lwed_singleSNP_summary_0x.txt", quote = FALSE, sep = "\t", row.names = FALSE)

write.table(SIMP_singleSNP_summary_0x, "./04_tamRun4/01_nanopore/03_run4GTscore/ont_simp_singleSNP_summary_0x.txt", quote = FALSE, sep = "\t", row.names = FALSE)
```
...
#write results
write.table(fullSet_singleSNP_summary_10x, "./04_tamRun4/01_nanopore/03_run4GTscore/ont_fullSet_singleSNP_summary_10x.txt", quote = FALSE, sep = "\t", row.names = FALSE)

write.table(posDual_singleSNP_summary_10x, "./04_tamRun4/01_nanopore/03_run4GTscore/ont_posDual_singleSNP_summary_10x.txt", quote = FALSE, sep = "\t", row.names = FALSE)

write.table(LWED_singleSNP_summary_10x, "./04_tamRun4/01_nanopore/03_run4GTscore/ont_lwed_singleSNP_summary_10x.txt", quote = FALSE, sep = "\t", row.names = FALSE)

write.table(SIMP_singleSNP_summary_10x, "./04_tamRun4/01_nanopore/03_run4GTscore/ont_simp_singleSNP_summary_10x.txt", quote = FALSE, sep = "\t", row.names = FALSE)
```
...
ls_posDual <- read.table("./04_tamRun4/01_nanopore/03_run4GTscore/ont_posDual_GTscore_locusSummary.txt", header = T, sep = "\t") %>%
  mutate(
    sampleSet = "posSamples"
  )

ls_lwed <- read.table("./04_tamRun4/01_nanopore/03_run4GTscore/ont_lwed_GTscore_locusSummary.txt", header = T, sep = "\t") %>%
  mutate(
    sampleSet = "lwedSamples"
  )

ls_simp <- read.table("./04_tamRun4/01_nanopore/03_run4GTscore/ont_simp_GTscore_locusSummary.txt", header = T, sep = "\t") %>%
  mutate(
...
write.csv(master_locusSummary, "./04_tamRun4/01_nanopore/03_run4GTscore/summaryFiles/ont_master_locusSummary.csv", row.names = F)
```
...
write.csv(fullSet_singleSNP_sampleSummary_0x, "./04_tamRun4/01_nanopore/03_run4GTscore/ont_fullSet_singleSNP_sampleSummary_0x.csv", row.names = F)

write.csv(posDual_singleSNP_sampleSummary_0x, "./04_tamRun4/01_nanopore/03_run4GTscore/ont_posDual_singleSNP_sampleSummary_0x.csv", row.names = F)

write.csv(LWED_singleSNP_sampleSummary_0x, "./04_tamRun4/01_nanopore/03_run4GTscore/ont_lwed_singleSNP_sampleSummary_0x.csv", row.names = F)

write.csv(SIMP_singleSNP_sampleSummary_0x, "./04_tamRun4/01_nanopore/03_run4GTscore/ont_simp_singleSNP_sampleSummary_0x.csv", row.names = F)
```
...
write.csv(fullSet_singleSNP_sampleSummary_10x, "./04_tamRun4/01_nanopore/03_run4GTscore/ont_fullSet_singleSNP_sampleSummary_10x.csv", row.names = F)

write.csv(posDual_singleSNP_sampleSummary_10x, "./04_tamRun4/01_nanopore/03_run4GTscore/ont_posDual_singleSNP_sampleSummary_10x.csv", row.names = F)

write.csv(LWED_singleSNP_sampleSummary_10x, "./04_tamRun4/01_nanopore/03_run4GTscore/ont_lwed_singleSNP_sampleSummary_10x.csv", row.names = F)

write.csv(SIMP_singleSNP_sampleSummary_10x, "./04_tamRun4/01_nanopore/03_run4GTscore/ont_simp_singleSNP_sampleSummary_10x.csv", row.names = F)
```
...
is_neg <- read.delim("./04_tamRun4/01_nanopore/03_run4GTscore/ont_fullSet_GTscore_individualSummary.txt", header = TRUE, stringsAsFactors = FALSE) %>%
  mutate(Sample = gsub("-", "\\.", Sample)) %>%
  filter(!Sample %in% lwed$sampleID_ont) %>%
  filter(!Sample %in% simp$sampleID_ont)

is_lwed <- read.delim("./04_tamRun4/01_nanopore/03_run4GTscore/ont_lwed_GTscore_individualSummary.txt", header = TRUE, stringsAsFactors = FALSE) %>%
  mutate(Sample = gsub("-", "\\.", Sample))

is_simp <- read.delim("./04_tamRun4/01_nanopore/03_run4GTscore/ont_simp_GTscore_individualSummary.txt", header = TRUE, stringsAsFactors = FALSE) %>%
  mutate(Sample = gsub("-", "\\.", Sample))
...
master_sampleSummary <- indSum_combo %>%
  ...
  # add metadata
  merge(., md[, c("sampleID_ont", "sampleID_unique")], by.x = "sampleID", by.y = "sampleID_ont") %>%
  relocate(sampleID_unique, .after = sampleID)

write.csv(master_sampleSummary, "./04_tamRun4/01_nanopore/03_run4GTscore/summaryFiles/ont_master_sampleSummary.csv", row.names = F)
```
