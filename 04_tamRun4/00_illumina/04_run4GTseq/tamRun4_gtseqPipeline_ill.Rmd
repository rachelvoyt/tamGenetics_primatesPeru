...
This document outlines data analysis for tamGenetics_run4 ILLUIMINA sequences using the "GTseq pipeline" ([GitHub link](https://github.com/GTseq/GTseq-Pipeline)) created by Nate Campbell.
...
for i in ./../02_run4Interleaved_ill/tamRun4*; do perl ./../../../GTseq_sourceScripts/GTseq_HashSeqs.pl $i > ./hashSeqs/$(basename "${i/.fastq/.hash}"); done
```
