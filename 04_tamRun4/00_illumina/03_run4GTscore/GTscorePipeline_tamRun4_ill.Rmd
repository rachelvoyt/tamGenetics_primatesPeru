...
This pipeline is to analyze the Illumina results for tamRun4 (the 30x3 sample type comparison project) and includes all steps needed to analyze MiSeq data output, including how to 1) download MiSeq sequencing files, 2) do quality checks, 3) create the necessary files for analysis in GTscore, and 4) run the GTscore pipeline itself.
...
The sequencing data used in this pipeline is from the full set of hair and blood samples and includes data from two MiSeq runs of this library. There are a total of **96 samples**, including 30 each of blood, fecal, and hair (-1 for hair) samples from 15 LWED and 15 SIMP individuals.
...
```{r}
lwedSamples <- filter(md, is.na(species) | !species == "SIMP") %>%
  select(sampleID_ill) %>%
  pull()

simpSamples <- filter(md, is.na(species) | !species == "LWED") %>%
  select(sampleID_ill) %>%
  pull()
...
pp_lwedSpec <- read.table("./05_tamRun5/03_run5GTscore/primerProbeFileV3_lwedSpec.txt", header = T)

pp_simpSpec <- read.table("./05_tamRun5/03_run5GTscore/primerProbeFileV3_simpSpec.txt", header = T)
```
...
write.table(pp_lwedSpec, "./05_tamRun5/03_run5GTscore/primerProbeFileV3_lwedSpec.txt", sep = "\t", row.names = F, col.names = T, quote = F)

write.table(pp_simpSpec, "./05_tamRun5/03_run5GTscore/primerProbeFileV3_simpSpec.txt", sep = "\t", row.names = F, col.names = T, quote = F)
```
...
system2("perl",
        args = "./project_scripts/GTscore_AmpliconReadCounter_modified.pl -p ./05_tamRun5/03_run5GTscore/primerProbeFileV3_fullSet.txt --files ./04_tamRun4/00_illumina/03_run4GTscore/ill_fullSet_sampleFiles.txt --inDir ./04_tamRun4/00_illumina/02_run4Interleaved/ --outDir ./04_tamRun4/00_illumina/03_run4GTscore/ --printMatched --printDiscarded --prefix ill_fullSet_")

# pos samples (no negs), dual loci
system2("perl",
        args="./project_scripts/GTscore_AmpliconReadCounter_modified.pl -p ./05_tamRun5/03_run5GTscore/primerProbeFileV3_dual.txt --files ./04_tamRun4/00_illumina/03_run4GTscore/ill_pos_sampleFiles.txt --inDir ./04_tamRun4/00_illumina/02_run4Interleaved/ --outDir ./04_tamRun4/00_illumina/03_run4GTscore/ --prefix ill_posDual_")

# lwed samples, lwed + dual loci
system2("perl",
        args="./project_scripts/GTscore_AmpliconReadCounter_modified.pl -p ./05_tamRun5/03_run5GTscore/primerProbeFileV3_LWED.txt --files ./04_tamRun4/00_illumina/03_run4GTscore/ill_lwed_sampleFiles.txt --inDir ./04_tamRun4/00_illumina/02_run4Interleaved/ --outDir ./04_tamRun4/00_illumina/03_run4GTscore/ --prefix ill_lwed_")

# lwed samples, simp-specific loci
system2("perl",
        args="./project_scripts/GTscore_AmpliconReadCounter_modified.pl -p ./05_tamRun5/03_run5GTscore/primerProbeFileV3_simpSpec.txt --files ./04_tamRun4/00_illumina/03_run4GTscore/ill_lwed_sampleFiles.txt --inDir ./04_tamRun4/00_illumina/02_run4Interleaved/ --outDir ./04_tamRun4/00_illumina/03_run4GTscore/ --prefix ill_lwed_simpSpec_")

# simp samples, simp + dual loci
system2("perl",
        args="./project_scripts/GTscore_AmpliconReadCounter_modified.pl -p ./05_tamRun5/03_run5GTscore/primerProbeFileV3_SIMP.txt --files ./04_tamRun4/00_illumina/03_run4GTscore/ill_simp_sampleFiles.txt --inDir ./04_tamRun4/00_illumina/02_run4Interleaved/ --outDir ./04_tamRun4/00_illumina/03_run4GTscore/ --prefix ill_simp_")

# simp samples, lwed-specific loci
system2("perl",
        args="./project_scripts/GTscore_AmpliconReadCounter_modified.pl -p ./05_tamRun5/03_run5GTscore/primerProbeFileV3_lwedSpec.txt --files ./04_tamRun4/00_illumina/03_run4GTscore/ill_simp_sampleFiles.txt --inDir ./04_tamRun4/00_illumina/02_run4Interleaved/ --outDir ./04_tamRun4/00_illumina/03_run4GTscore/ --prefix ill_simp_lwedSpec_")
```
...
master_sampleSummary <- indSum_combo %>%
  ...
  # add metadata
  merge(., md[, c("sampleID_ill", "sampleID_unique", "sampleType")], by.x = "sampleID", by.y = "sampleID_ill") %>%
  relocate(c(sampleID_unique, sampleType), .after = sampleID)
