...
capData_byIndiv <- read.csv("./DISSERTATION/ch2_demographics/01_dataOrganization/02_dataCleaning/captureData_byIndividual_v6.csv") %>%
...
I just did juveniles vs. non-juveniles here rather than looking at subadult/adult distinctions -- mostly bc I think these are a touch iffy, plus there are some indivs with NA for ageClass
