...
```{r}
sampleRef <- run1_md[, c("seqRun", "sampleID", "sampleRef", "sampleType", "animalID", "sex")] %>%
  rbind(., run3_md[, c("seqRun", "sampleID", "sampleRef", "sampleType", "animalID", "sex")]) %>%
  rbind(., run4_md_ill[, c("seqRun", "sampleID", "sampleRef", "sampleType", "animalID", "sex")]) %>%
  rbind(., run4_md_ont[, c("seqRun", "sampleID", "sampleRef", "sampleType", "animalID", "sex")]) %>%
  rbind(., run5_md[, c("seqRun", "sampleID", "sampleRef", "sampleType", "animalID", "sex")]) %>%
  rbind(., run_wgs[, c("seqRun", "sampleID", "sampleRef", "sampleType", "animalID", "sex")]) %>%
