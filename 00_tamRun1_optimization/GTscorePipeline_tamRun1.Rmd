...
# Navigate to the directory with the original .fastq.gz files from the Illumina sequencing run
cd 00_optimization
...
for i in ./00_optSeqs/*_R1_001.fastq.gz; do name=$(basename $i _R1_001.fastq.gz); reformat.sh in=00_optSeqs/${name}_R1_001.fastq.gz in2=00_optSeqs/${name}_R2_001.fastq.gz out=01_optInterleaved/${name}_interleaved.fastq.gz; done

# cd to 01_optInterleaved and extract all .gz files
