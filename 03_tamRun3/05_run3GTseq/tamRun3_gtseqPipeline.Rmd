...
for i in ./../02_run3Interleaved/tamRun3*; do perl ./../../project_scripts/GTseq/GTseq_Genotyper_v3_rvModified.pl locusInfo_genotyper.csv $i > ./genos/$(basename "${i/.fastq/.genos}"); done
```
