...
# LWED
system2("perl",
        args="./03_tamRun3/03_run3GTscore/AmpliconReadCounter.pl -p ./03_tamRun3/03_run3GTscore/primerProbeFile_LWED.txt --files ./03_tamRun3/03_run3GTscore/sampleFiles_LWED+_cat.txt --inDir ./03_tamRun3/02_run3Interleaved/ --outDir ./03_tamRun3/03_run3GTscore/ --prefix LWED_cat_")
...
#write results
write.table(fullSet_polyGenResults_singleSNP,"./03_tamRun3/03_run3GTscore/fullSet_polyGenResults_singleSNP_abcat_10x.txt",quote=FALSE,sep="\t")
...
fullSet_singleSNP_alleleReads_no10x <- read.delim("./03_tamRun3/03_run3GTscore/fullSet_a_AlleleReads_singleSNPs.txt",header=TRUE,row.names=1,stringsAsFactors=FALSE)

#generate singleSNP genotypes using the polyGen algorithm, adjust "0" formatting
fullSet_polyGenResults_singleSNP_no10x <- polyGen(fullSet_singleSNP_locusTable_no10x, fullSet_singleSNP_alleleReads_no10x)

#write results
write.table(fullSet_polyGenResults_singleSNP_no10x,"./03_tamRun3/03_run3GTscore/fullSet_polyGenResults_singleSNP_abcat_no10x.txt",quote=FALSE,sep="\t")
```
...
LWED_singleSNP_alleleReads<-read.delim("./03_tamRun3/03_run3GTscore/LWED_abcat_AlleleReads_singleSNPs_10x.txt",header=TRUE,row.names=1,stringsAsFactors=FALSE)
...
#write results
write.table(LWED_polyGenResults_singleSNP,"./03_tamRun3/03_run3GTscore/LWED_abcat_polyGenResults_singleSNP.txt",quote=FALSE,sep="\t")
```
...
SIMP_singleSNP_alleleReads<-read.delim("./03_tamRun3/03_run3GTscore/SIMP_abcat_AlleleReads_singleSNPs_10x.txt",header=TRUE,row.names=1,stringsAsFactors=FALSE)

#generate singleSNP genotypes using the polyGen algorithm
SIMP_polyGenResults_singleSNP<-polyGen(SIMP_singleSNP_locusTable,SIMP_singleSNP_alleleReads)

#write results
write.table(SIMP_polyGenResults_singleSNP,"./03_tamRun3/03_run3GTscore/SIMP_abcat_polyGenResults_singleSNP.txt",quote=FALSE,sep="\t")
```

[STOPPED UPDATING HERE 24 MAY 2023]
...
#write results
write.table(fullSet_singleSNP_summary,"./03_tamRun3/03_run3GTscore/fullSet_singleSNP_summary.txt",quote=FALSE,sep="\t",row.names=FALSE)
write.table(LWED_singleSNP_summary,"./03_tamRun3/03_run3GTscore/LWED_singleSNP_summary.txt",quote=FALSE,sep="\t",row.names=FALSE)
write.table(SIMP_singleSNP_summary,"./03_tamRun3/03_run3GTscore/SIMP_singleSNP_summary.txt",quote=FALSE,sep="\t",row.names=FALSE)
```
...
ls <- read.table("./03_tamRun3/03_run3GTscore/fullSet_GTscore_locusSummary.txt", header = T, sep = "\t")
lwed_ls <- read.table("./03_tamRun3/03_run3GTscore/LWED_GTscore_locusSummary.txt", header = T, sep = "\t")
simp_ls <- read.table("./03_tamRun3/03_run3GTscore/SIMP_GTscore_locusSummary.txt", header = T, sep = "\t")
...
# Export
write.csv(ls_ss, "./03_tamRun3/03_run3GTscore/summaryFiles/master_locusSummary.csv", row.names = F)
```
...
```{r}
fullSet_GTscore_individualSummary <- read.delim("./03_tamRun3/03_run3GTscore/fullSet_GTscore_individualSummary.txt", header = TRUE, stringsAsFactors = FALSE)
...
```{r}
fullSet_singleSNP_sampleSummary <- summarizeSamples(fullSet_polyGenResults_singleSNP, fullSet_singleSNP_alleleReads) %>%
  mutate(sample = gsub("\\.", "-", sample))

write.csv(fullSet_singleSNP_sampleSummary, "./03_tamRun3/03_run3GTscore/fullSet_singleSNP_sampleSummary.csv", row.names = F)
