...
Create separate tamRun3, tamRun3b, and cat_tamRun3 sample files

```{r}
sf_fullSet_a <- sf_fullSet %>%
  filter(., grepl("tamRun3-", V1)) %>%
  filter(., !grepl("cat_", V1))

sf_fullSet_b <- sf_fullSet %>%
  filter(., grepl("tamRun3b", V1))
...
Use md file with a, b, and cat samples to create sample file species subsets. Note that we're including the negative controls in both species subsets 
...
system2("perl",
        args="./03_tamRun3/03_run3GTscore/AmpliconReadCounter.pl -p ./03_tamRun3/03_run3GTscore/primerProbeFile_fullSet.txt --files ./03_tamRun3/03_run3GTscore/sampleFiles_fullSet_a.txt --inDir ./03_tamRun3/02_run3Interleaved/ --outDir ./03_tamRun3/03_run3GTscore/ --prefix fullSet_a_")

# LWED
system2("perl",
        args="./03_tamRun3/03_run3GTscore/AmpliconReadCounter.pl -p ./03_tamRun3/03_run3GTscore/primerProbeFile_LWED.txt --files ./03_tamRun3/03_run3GTscore/sampleFiles_LWED_a.txt --inDir ./03_tamRun3/02_run3Interleaved/ --outDir ./03_tamRun3/03_run3GTscore/ --prefix LWED_a_")

# SIMP
system2("perl",
        args="./03_tamRun3/03_run3GTscore/AmpliconReadCounter.pl -p ./03_tamRun3/03_run3GTscore/primerProbeFile_SIMP.txt --files ./03_tamRun3/03_run3GTscore/sampleFiles_SIMP_a.txt --inDir ./03_tamRun3/02_run3Interleaved/ --outDir ./03_tamRun3/03_run3GTscore/ --prefix SIMP_a_")
```
...
# All samples, all loci
system2("perl",
        args="./03_tamRun3/03_run3GTscore/AmpliconReadCounter.pl -p ./03_tamRun3/03_run3GTscore/primerProbeFile_fullSet.txt --files ./03_tamRun3/03_run3GTscore/sampleFiles_fullSet_b.txt --inDir ./03_tamRun3/02_run3Interleaved/ --outDir ./03_tamRun3/03_run3GTscore/ --prefix fullSet_b_")

# LWED
system2("perl",
        args="./03_tamRun3/03_run3GTscore/AmpliconReadCounter.pl -p ./03_tamRun3/03_run3GTscore/primerProbeFile_LWED.txt --files ./03_tamRun3/03_run3GTscore/sampleFiles_LWED_b.txt --inDir ./03_tamRun3/02_run3Interleaved/ --outDir ./03_tamRun3/03_run3GTscore/ --prefix LWED_b_")

# SIMP
system2("perl",
        args="./03_tamRun3/03_run3GTscore/AmpliconReadCounter.pl -p ./03_tamRun3/03_run3GTscore/primerProbeFile_SIMP.txt --files ./03_tamRun3/03_run3GTscore/sampleFiles_SIMP_b.txt --inDir ./03_tamRun3/02_run3Interleaved/ --outDir ./03_tamRun3/03_run3GTscore/ --prefix SIMP_b_")
```
...
# All samples, all loci
system2("perl",
        args="./03_tamRun3/03_run3GTscore/AmpliconReadCounter.pl -p ./03_tamRun3/03_run3GTscore/primerProbeFile_fullSet.txt --files ./03_tamRun3/03_run3GTscore/sampleFiles_fullSet_cat.txt --inDir ./03_tamRun3/02_run3Interleaved/ --outDir ./03_tamRun3/03_run3GTscore/ --prefix fullSet_cat_")

# LWED
system2("perl",
        args="./03_tamRun3/03_run3GTscore/AmpliconReadCounter.pl -p ./03_tamRun3/03_run3GTscore/primerProbeFile_LWED.txt --files ./03_tamRun3/03_run3GTscore/sampleFiles_LWED_cat.txt --inDir ./03_tamRun3/02_run3Interleaved/ --outDir ./03_tamRun3/03_run3GTscore/ --prefix LWED_cat_")

# SIMP
system2("perl",
        args="./03_tamRun3/03_run3GTscore/AmpliconReadCounter.pl -p ./03_tamRun3/03_run3GTscore/primerProbeFile_SIMP.txt --files ./03_tamRun3/03_run3GTscore/sampleFiles_SIMP_cat.txt --inDir ./03_tamRun3/02_run3Interleaved/ --outDir ./03_tamRun3/03_run3GTscore/ --prefix SIMP_cat_")
```
...
## 6.1 Identify loci \<10x coverage
...
write.table(readCounts,"./03_tamRun3/03_run3GTscore/fullSet_abcat_AlleleReads_singleSNPs_10x.txt",quote=FALSE,sep="\t")
write.table(readCounts_lwed,"./03_tamRun3/03_run3GTscore/LWED_abcat_AlleleReads_singleSNPs_10x.txt",quote=FALSE,sep="\t")
write.table(readCounts_simp,"./03_tamRun3/03_run3GTscore/SIMP_abcat_AlleleReads_singleSNPs_10x.txt",quote=FALSE,sep="\t")
```
...
Genotype file includes separate genotypes for a, b, and cat sequencing results.
...
fullSet_singleSNP_alleleReads<-read.delim("./03_tamRun3/03_run3GTscore/fullSet_abcat_AlleleReads_singleSNPs_10x.txt",header=TRUE,row.names=1,stringsAsFactors=FALSE)
...
# write results
write.table(fullSet_polyGenResults_singleSNP,"./03_tamRun3/03_run3GTscore/fullSet_abcat_polyGenResults_singleSNP_10x.txt",quote=FALSE,sep="\t")
```

### abcat - no 10x

Genotype without ditching loci under 10x

```{r}
# Create abcat allele reads file
readCounts_no10x <- cbind(readCounts_a, readCounts_b, readCounts_cat)
write.table(readCounts_no10x,"./03_tamRun3/03_run3GTscore/fullSet_abcat_AlleleReads_singleSNPs_no10x.txt",quote=FALSE,sep="\t")

#load locus table and original allele reads file
fullSet_singleSNP_locusTable_no10x <- read.delim("./03_tamRun3/03_run3GTscore/fullSet_a_LocusTable_singleSNPs.txt", header=TRUE, stringsAsFactors = FALSE)

fullSet_singleSNP_alleleReads_no10x <- read.delim("./03_tamRun3/03_run3GTscore/fullSet_abcat_AlleleReads_singleSNPs_no10x.txt",header=TRUE,row.names=1,stringsAsFactors=FALSE)

#generate singleSNP genotypes using the polyGen algorithm, adjust "0" formatting
fullSet_polyGenResults_singleSNP_no10x <- polyGen(fullSet_singleSNP_locusTable_no10x, fullSet_singleSNP_alleleReads_no10x)

#write results
write.table(fullSet_polyGenResults_singleSNP_no10x,"./03_tamRun3/03_run3GTscore/fullSet_abcat_polyGenResults_singleSNP_no10x.txt",quote=FALSE,sep="\t")
```
...
```{r}
#load locus table and 10x allele reads file
fullSet_cat_singleSNP_locusTable<-read.delim("./03_tamRun3/03_run3GTscore/fullSet_a_LocusTable_singleSNPs.txt",header=TRUE,stringsAsFactors=FALSE)
fullSet_cat_singleSNP_alleleReads<-fullSet_singleSNP_alleleReads %>%
  select(starts_with("cat"))

#generate singleSNP genotypes using the polyGen algorithm, adjust "0" formatting
fullSet_cat_polyGenResults_singleSNP<-polyGen(fullSet_cat_singleSNP_locusTable,fullSet_cat_singleSNP_alleleReads)

# write results
write.table(fullSet_cat_polyGenResults_singleSNP,"./03_tamRun3/03_run3GTscore/fullSet_cat_polyGenResults_singleSNP_10x.txt",quote=FALSE,sep="\t")
```
...
```{r Genotyping}
#load locus table and 10x allele reads file
LWED_abcat_singleSNP_locusTable<-read.delim("./03_tamRun3/03_run3GTscore/LWED_a_LocusTable_singleSNPs.txt",header=TRUE,stringsAsFactors=FALSE)
LWED_abcat_singleSNP_alleleReads<-read.delim("./03_tamRun3/03_run3GTscore/LWED_abcat_AlleleReads_singleSNPs_10x.txt",header=TRUE,row.names=1,stringsAsFactors=FALSE)

#generate singleSNP genotypes using the polyGen algorithm
LWED_abcat_polyGenResults_singleSNP<-polyGen(LWED_abcat_singleSNP_locusTable,LWED_abcat_singleSNP_alleleReads)

#write results
write.table(LWED_abcat_polyGenResults_singleSNP,"./03_tamRun3/03_run3GTscore/LWED_abcat_polyGenResults_singleSNP.txt",quote=FALSE,sep="\t")
```
...
```{r}
# lwed sample names
samplesLWED <- sf_lwed_cat %>%
  mutate(V1 = gsub(".fastq", "", V1)) %>%
  mutate(V1 = gsub("-", "\\.", V1))

#load locus table and 10x allele reads file
LWED_cat_singleSNP_locusTable<-read.delim("./03_tamRun3/03_run3GTscore/LWED_a_LocusTable_singleSNPs.txt",header=TRUE,stringsAsFactors=FALSE)
LWED_cat_singleSNP_alleleReads<-LWED_abcat_singleSNP_alleleReads %>%
  select(any_of(samplesLWED$V1))

#generate singleSNP genotypes using the polyGen algorithm
LWED_cat_polyGenResults_singleSNP<-polyGen(LWED_cat_singleSNP_locusTable,LWED_cat_singleSNP_alleleReads)

#write results
write.table(LWED_cat_polyGenResults_singleSNP,"./03_tamRun3/03_run3GTscore/LWED_cat_polyGenResults_singleSNP.txt",quote=FALSE,sep="\t")
```
...
```{r}
#load locus table and 10x allele reads file
SIMP_abcat_singleSNP_locusTable<-read.delim("./03_tamRun3/03_run3GTscore/SIMP_a_LocusTable_singleSNPs.txt",header=TRUE,stringsAsFactors=FALSE)
SIMP_abcat_singleSNP_alleleReads<-read.delim("./03_tamRun3/03_run3GTscore/SIMP_abcat_AlleleReads_singleSNPs_10x.txt",header=TRUE,row.names=1,stringsAsFactors=FALSE)

#generate singleSNP genotypes using the polyGen algorithm
SIMP_abcat_polyGenResults_singleSNP<-polyGen(SIMP_abcat_singleSNP_locusTable,SIMP_abcat_singleSNP_alleleReads)

#write results
write.table(SIMP_abcat_polyGenResults_singleSNP,"./03_tamRun3/03_run3GTscore/SIMP_abcat_polyGenResults_singleSNP.txt",quote=FALSE,sep="\t")
```
...
```{r}
# simp sample names
samplesSIMP <- sf_simp_cat %>%
  mutate(V1 = gsub(".fastq", "", V1)) %>%
  mutate(V1 = gsub("-", "\\.", V1))

#load locus table and 10x allele reads file
SIMP_cat_singleSNP_locusTable<-read.delim("./03_tamRun3/03_run3GTscore/SIMP_a_LocusTable_singleSNPs.txt",header=TRUE,stringsAsFactors=FALSE)
SIMP_cat_singleSNP_alleleReads<-SIMP_abcat_singleSNP_alleleReads %>%
  select(any_of(samplesSIMP$V1))

#generate singleSNP genotypes using the polyGen algorithm
SIMP_cat_polyGenResults_singleSNP<-polyGen(SIMP_cat_singleSNP_locusTable,SIMP_cat_singleSNP_alleleReads)

#write results
write.table(SIMP_cat_polyGenResults_singleSNP,"./03_tamRun3/03_run3GTscore/SIMP_cat_polyGenResults_singleSNP.txt",quote=FALSE,sep="\t")
```
...
NOTE that locus summaries are based on "cat_" samples

```{r}
#summarize single SNP results
fullSet_cat_singleSNP_summary <- summarizeGTscore(fullSet_cat_singleSNP_alleleReads, fullSet_cat_singleSNP_locusTable, fullSet_cat_polyGenResults_singleSNP)

LWED_cat_singleSNP_summary <- summarizeGTscore(LWED_cat_singleSNP_alleleReads, LWED_cat_singleSNP_locusTable, LWED_cat_polyGenResults_singleSNP)

SIMP_cat_singleSNP_summary <- summarizeGTscore(SIMP_cat_singleSNP_alleleReads, SIMP_cat_singleSNP_locusTable, SIMP_cat_polyGenResults_singleSNP)

#write results
write.table(fullSet_cat_singleSNP_summary,"./03_tamRun3/03_run3GTscore/fullSet_cat_singleSNP_summary.txt",quote=FALSE,sep="\t",row.names=FALSE)
write.table(LWED_cat_singleSNP_summary,"./03_tamRun3/03_run3GTscore/LWED_cat_singleSNP_summary.txt",quote=FALSE,sep="\t",row.names=FALSE)
write.table(SIMP_cat_singleSNP_summary,"./03_tamRun3/03_run3GTscore/SIMP_cat_singleSNP_summary.txt",quote=FALSE,sep="\t",row.names=FALSE)
```
...
ls <- read.table("./03_tamRun3/03_run3GTscore/fullSet_cat_GTscore_locusSummary.txt", header = T, sep = "\t")
lwed_ls <- read.table("./03_tamRun3/03_run3GTscore/LWED_cat_GTscore_locusSummary.txt", header = T, sep = "\t")
simp_ls <- read.table("./03_tamRun3/03_run3GTscore/SIMP_cat_GTscore_locusSummary.txt", header = T, sep = "\t")
...
## SingleSNP summaries
ss <- fullSet_cat_singleSNP_summary %>%
  filter(!str_detect(Locus_ID, "LWED|SIMP"))
lwed_ss <- LWED_cat_singleSNP_summary %>%
  filter(str_detect(Locus_ID, "LWED"))
simp_ss <- SIMP_cat_singleSNP_summary %>%
...
ss_recombine$Locus_ID <- sub("_[^_]+$", "\\1", ss_recombine$Locus_ID)

ls_ss <- merge(ls_recombine, ss_recombine, by.x = "Locus", by.y = "Locus_ID") 

# Export
write.csv(ls_ss, "./03_tamRun3/03_run3GTscore/summaryFiles/master_cat_locusSummary.csv", row.names = F)
```
...
Creating sample summaries based on a, b, and cat samples

load sample summaries from AmpliconReadCounter

```{r}
# Full set (a, b, cat)
fullSet_abcat_GTscore_individualSummary <- rbind(read.delim("./03_tamRun3/03_run3GTscore/fullSet_a_GTscore_individualSummary.txt", header = TRUE, stringsAsFactors = FALSE),
                                           read.delim("./03_tamRun3/03_run3GTscore/fullSet_b_GTscore_individualSummary.txt", header = TRUE, stringsAsFactors = FALSE),
                                           read.delim("./03_tamRun3/03_run3GTscore/fullSet_cat_GTscore_individualSummary.txt", header = TRUE, stringsAsFactors = FALSE))

# LWED (a, b, cat)
LWED_abcat_GTscore_individualSummary <- rbind(read.delim("./03_tamRun3/03_run3GTscore/LWED_a_GTscore_individualSummary.txt", header = TRUE, stringsAsFactors = FALSE),
                          read.delim("./03_tamRun3/03_run3GTscore/LWED_b_GTscore_individualSummary.txt", header = TRUE, stringsAsFactors = FALSE),
                          read.delim("./03_tamRun3/03_run3GTscore/LWED_cat_GTscore_individualSummary.txt", header = TRUE, stringsAsFactors = FALSE))

# SIMP (a, b, cat)
SIMP_abcat_GTscore_individualSummary <- rbind(read.delim("./03_tamRun3/03_run3GTscore/SIMP_b_GTscore_individualSummary.txt", header = TRUE, stringsAsFactors = FALSE),
                   read.delim("./03_tamRun3/03_run3GTscore/SIMP_a_GTscore_individualSummary.txt", header = TRUE, stringsAsFactors = FALSE),
                   read.delim("./03_tamRun3/03_run3GTscore/SIMP_cat_GTscore_individualSummary.txt", header = TRUE, stringsAsFactors = FALSE))    
```
...
**added a few lines to do a separate file fullSet_singleSNP_sampleSummary for comparisons to gt-seq pipeline (the master summary I made doesn't count species-specific loci for uninformative species)

```{r}
fullSet_abcat_singleSNP_sampleSummary <- summarizeSamples(fullSet_polyGenResults_singleSNP, fullSet_singleSNP_alleleReads) %>%
  mutate(sample = gsub("\\.", "-", sample))

write.csv(fullSet_abcat_singleSNP_sampleSummary, "./03_tamRun3/03_run3GTscore/fullSet_abcat_singleSNP_sampleSummary.csv", row.names = F)

LWED_abcat_singleSNP_sampleSummary <- summarizeSamples(LWED_abcat_polyGenResults_singleSNP, LWED_abcat_singleSNP_alleleReads) %>%
  mutate(sample = gsub("\\.", "-", sample))

SIMP_abcat_singleSNP_sampleSummary <- summarizeSamples(SIMP_abcat_polyGenResults_singleSNP, SIMP_abcat_singleSNP_alleleReads) %>%
  mutate(sample = gsub("\\.", "-", sample))
```
...
LWED_abcat_gtIndivSummary <- LWED_abcat_GTscore_individualSummary %>%
  mutate(lociSet = "LWED") %>%
  merge(., LWED_abcat_singleSNP_sampleSummary, by.x = "Sample", by.y = "sample")

SIMP_abcat_gtIndivSummary <- SIMP_abcat_GTscore_individualSummary %>%
  mutate(lociSet = "SIMP") %>%
  merge(., SIMP_abcat_singleSNP_sampleSummary, by.x = "Sample", by.y = "sample")

# Combine LWED & SIMP to form one, adjust sample name
lwedSIMP_abcat_gtIndivSummary <- rbind(LWED_abcat_gtIndivSummary, SIMP_abcat_gtIndivSummary) %>%
...
master_abcat_sampleSummary <- merge(lwedSIMP_abcat_gtIndivSummary, md, by = "sampleFile")
master_cat_sampleSummary <- master_abcat_sampleSummary %>%
  filter(str_detect(sampleFile, "cat"))

# Export
write.csv(master_abcat_sampleSummary, "./03_tamRun3/03_run3GTscore/summaryFiles/master_abcat_sampleSummary.csv", row.names = F)
write.csv(master_cat_sampleSummary, "./03_tamRun3/03_run3GTscore/summaryFiles/master_cat_sampleSummary.csv", row.names = F)
```
