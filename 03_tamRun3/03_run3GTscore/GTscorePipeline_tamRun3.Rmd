...
The sequence data used in this pipeline is from tamRun3, the third MiSeq sequencing run with the full set of hair and blood samples. This run has a total of **438 samples**.
...
```{r}
md <- read.csv("tamRun3_metadata_12Jan2022.csv") %>%
...
## 6.4 Export genotype files

### 6.4.1 Genepop format
