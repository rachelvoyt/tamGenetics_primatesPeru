...
```{r}
md <- read.csv("./03_tamRun3/03_run3GTscore/tamRun3_metadata_12Jan2023.csv") %>%
...
readCounts <- read.table("./03_tamRun3/03_run3GTscore/fullSet_AlleleReads_singleSNPs.txt")
...
lwed_loci <- read.delim("./03_tamRun3/03_run3GTscore/LWED_LocusTable_singleSNPs.txt",header=TRUE,stringsAsFactors=FALSE)
simp_loci <- read.delim("./03_tamRun3/03_run3GTscore/SIMP_LocusTable_singleSNPs.txt",header=TRUE,stringsAsFactors=FALSE)
...
fullSet_singleSNP_locusTable<-read.delim("./03_tamRun3/03_run3GTscore/fullSet_LocusTable_singleSNPs.txt",header=TRUE,stringsAsFactors=FALSE)
fullSet_singleSNP_alleleReads<-read.delim("./03_tamRun3/03_run3GTscore/fullSet_AlleleReads_singleSNPs_10x.txt",header=TRUE,row.names=1,stringsAsFactors=FALSE)
...
#write results
write.table(fullSet_polyGenResults_singleSNP,"./03_tamRun3/03_run3GTscore/fullSet_polyGenResults_singleSNP_10x.txt",quote=FALSE,sep="\t")
...
fullSet_singleSNP_locusTable_no10x <- read.delim("./03_tamRun3/03_run3GTscore/fullSet_LocusTable_singleSNPs.txt", header=TRUE, stringsAsFactors = FALSE)

fullSet_singleSNP_alleleReads_no10x <- read.delim("./03_tamRun3/03_run3GTscore/fullSet_AlleleReads_singleSNPs.txt",header=TRUE,row.names=1,stringsAsFactors=FALSE)

#generate singleSNP genotypes using the polyGen algorithm, adjust "0" formatting
fullSet_polyGenResults_singleSNP_no10x <- polyGen(fullSet_singleSNP_locusTable_no10x, fullSet_singleSNP_alleleReads_no10x)

#write results
write.table(fullSet_polyGenResults_singleSNP_no10x,"./03_tamRun3/03_run3GTscore/fullSet_polyGenResults_singleSNP_no10x.txt",quote=FALSE,sep="\t")
```
...
```{r Genotyping}
#load locus table and 10x allele reads file
LWED_singleSNP_locusTable<-read.delim("./03_tamRun3/03_run3GTscore/LWED_LocusTable_singleSNPs.txt",header=TRUE,stringsAsFactors=FALSE)
LWED_singleSNP_alleleReads<-read.delim("./03_tamRun3/03_run3GTscore/LWED_AlleleReads_singleSNPs_10x.txt",header=TRUE,row.names=1,stringsAsFactors=FALSE)
...
#write results
write.table(LWED_polyGenResults_singleSNP,"./03_tamRun3/03_run3GTscore/LWED_polyGenResults_singleSNP.txt",quote=FALSE,sep="\t")
```
...
```{r Genotyping}
#load locus table and 10x allele reads file
SIMP_singleSNP_locusTable<-read.delim("./03_tamRun3/03_run3GTscore/SIMP_LocusTable_singleSNPs.txt",header=TRUE,stringsAsFactors=FALSE)
SIMP_singleSNP_alleleReads<-read.delim("./03_tamRun3/03_run3GTscore/SIMP_AlleleReads_singleSNPs_10x.txt",header=TRUE,row.names=1,stringsAsFactors=FALSE)

#generate singleSNP genotypes using the polyGen algorithm
SIMP_polyGenResults_singleSNP<-polyGen(SIMP_singleSNP_locusTable,SIMP_singleSNP_alleleReads)

#write results
write.table(SIMP_polyGenResults_singleSNP,"./03_tamRun3/03_run3GTscore/SIMP_polyGenResults_singleSNP.txt",quote=FALSE,sep="\t")
```
