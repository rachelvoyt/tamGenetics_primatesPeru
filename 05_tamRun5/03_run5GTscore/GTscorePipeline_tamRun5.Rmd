...
# Run fastqc
for i in ../00_run5Seqs/*; do fastqc $i; done
...
for i in *fastq; do echo $i; done > ./../03_run5GTscore/sampleFiles_fullSet.txt
```

Load into R

```{r}
sf_fullSet <- read.table("./05_tamRun5/03_run5GTscore/sampleFiles_fullSet.txt")
```
...
# Export sample files
write.table(sf_lwed, file = "./05_tamRun5/03_run5GTscore/sampleFiles_LWED.txt", sep = "\t", row.names = F, col.names = F, quote = F)

write.table(sf_simp, file = "./05_tamRun5/03_run5GTscore/sampleFiles_SIMP.txt", sep = "\t", row.names = F, col.names = F, quote = F)
```
...
system2("perl",
        args="./GTscore_sourceScripts/AmpliconReadCounter.pl -p ./05_tamRun5/03_run5GTscore/primerProbeFileV3_fullSet.txt --files ./05_tamRun5/03_run5GTscore/sampleFiles_fullSet.txt --inDir ./05_tamRun5/02_run5Interleaved/ --outDir ./05_tamRun5/03_run5GTscore/ --prefix fullSet_")

# LWED
system2("perl",
        args="./GTscore_sourceScripts/AmpliconReadCounter.pl -p ./05_tamRun5/03_run5GTscore/primerProbeFileV3_LWED.txt --files ./05_tamRun5/03_run5GTscore/sampleFiles_LWED.txt --inDir ./05_tamRun5/02_run5Interleaved/ --outDir ./05_tamRun5/03_run5GTscore/ --prefix LWED_")

# SIMP
system2("perl",
        args="./GTscore_sourceScripts/AmpliconReadCounter.pl -p ./05_tamRun5/03_run5GTscore/primerProbeFileV3_SIMP.txt --files ./05_tamRun5/03_run5GTscore/sampleFiles_SIMP.txt --inDir ./05_tamRun5/02_run5Interleaved/ --outDir ./05_tamRun5/03_run5GTscore/ --prefix SIMP_")
```
