...
FS = full sib
HS = half sib
HAN = half aunt-niece (or uncle/niece)
U = unrelated
...
They use max_mismatch = 500 out of 2500 total genos (i.e., 20%). 0.2*154 = 30.8
...
are 11 SNPs scored for \<50% of individuals ✖ There are 19 individuals
scored for \<5% of SNPs, these WILL BE IGNORED ✖ In addition, there are
23 individuals scored for \<20% of SNPs,it is advised to treat their
assignments with caution ℹ After exclusion, There are 116 individuals
and 153 SNPs.
...
SNPs scored for \<50% of individuals ✖ There are 8 individuals scored
for \<5% of SNPs, these WILL BE IGNORED ✖ In addition, there are 15
individuals scored for \<20% of SNPs,it is advised to treat their
assignments with caution ℹ After exclusion, There are 91 individuals and
150 SNPs.
